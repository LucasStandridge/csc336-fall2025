...
My app is a collection of all fully evolved pokemon, which allows the user to log in, curate favorites and teams, 
and come back to view them on the website.

I used the pokeapi that you used as a demo in class once, as well as Toast

I had a ton of fun making this, and did have to use the internet for some parts of the website, such as useNavigate and location, as well as some css help.
