...
import NavBoard from "./client/NavBoard.js";
import CreateUser from "./client/CreateUser.js"
import FetchPokemon from "./client/FinalEvolutions.js"
import FavoritePokemon from './client/FavoritePokemon.js';
...
export default function App() {
  ...
  const [current_user, setCurrentUser] = useState({id:1, name: "Lucas", password: "dev", favorite_pokemon: [248,3]})
  ...
  //was testing it made things easier, and I figure that it is better to just get it once the page starts anyway
    useEffect(() => {
        async function loadData() {
            //get the data
            const res = await fetch("http://localhost:3000/Pokemon_Data");  
